function UET(o) {
    ...
    this.knownEvents = {
        ...
        login: ["method"],
        page_view: ["page_title", "page_location", "page_path", "rep"],
    ...
    this.visitorExpirationTime = 1404e3;
    ...
    this.loadConfig = function () {
        ...
        u = "https:";
        r = 0;
        o.Ver === 1 && o.advertiserId !== undefined && (r = o.advertiserId);
        this.postURL = u + "//" + this.domain + "/action/" + r;
        this.urlPrefix = this.postURL + "?";
        this.errPrefix = u + "//" + this.domain + "/action-err/" + r + "?";
        this.previewPrefix = u + "//" + this.domain + "/actionp/" + r + "?";
        ...
        for (i in o) f.hasOwnProperty(i) && (this.beaconParams[i] = f[i] === 1 ? encodeURIComponent(o[i]) : o[i]);
    ...
    this.push = function () {
        var t = arguments,
            i, r, u = !1;
        if (t.length === 1)
            if (i = "event", t[0] === this.pageLoadEvt) r = [this.pageViewEvt, {}], u = !0;
            else {
        ...
        else if (t.length > 1 && t[0] !== this.pageLoadEvt) i = t[0], r = Array.prototype.slice.call(t, 1);
        else return;
        n.documentLoaded || i === "set" ? n._push([i, r, u]) : n.eventPushQueue.push([i, r, u])
    };
    ...
    this.dispatchq = function (n) {
        ...
        for (n || (this.evqDispatch = !0, this.uetConfig.disableVisibilityEvents === !1 && "onpagehide" in window && (window.addEventListener("pageshow", this.firePageShow.bind(this)), window.addEventListener("pagehide", this.firePageHide.bind(this)))), r = 0; r < this.evq.length; r++)
            if (typeof this.evq[r] == "object") {
                ...
                t = i = undefined
            } else typeof this.evq[r] == "string" || this.evq[r] instanceof String ? (t !== undefined && i !== undefined && (n || this.push(t, i, {}), t = i = undefined), f = this.evq[r], t === undefined && (f === "set" || f === "event") ? t = f : t !== undefined && i === undefined ? i = f : t = i = undefined, r !== this.evq.length - 1 || t !== "event" || n || i === undefined || this.push(t, i, {})) : t = i = undefined
    };
    ...
    this.fireSendBeacon = function (n) {
        var i = this.combine(this.beaconParams, {
            ...
            t = this.removeTrailingAmp(this.previewPrefix + this.stringifyToRequest(i));
